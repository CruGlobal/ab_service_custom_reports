function showLoadingBar(frameId, loadingElemId) {
   ...
   loadingElem.innerHTML =
      "<div class='webix_progress_top' role='progressbar' aria-valuemin='0' aria-valuemax='100' tabindex='0' style='color: #fff; height: 20px;'><div class='webix_progress_state' style='transition-duration: 10s; width: 0%; height: 100%;'> Loading...</div></div>";
